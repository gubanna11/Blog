...
public sealed class GetPagedCategoriesHandler : IRequestHandler<GetPagedCategoriesQuery, PagedResponse<CategoryResponse>>
{
    ...
    public async Task<PagedResponse<CategoryResponse>> Handle(GetPagedCategoriesQuery request, CancellationToken cancellationToken)
    {
